...
// Usuarios representa um respositório de usuários
...
// BuscarPorEmail, buscar um usuário por email e retorna o seu id e senha com hash
...
// Parar de seguir permite que um usuário pare de seguir o outro
