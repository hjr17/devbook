...
// NovoRepositorioDePulicacoes cria um repositório de publicações
...
// Buscar traz as publicações dos usuários seguidos e também do próprio usuários que fez a requisição
...
// Deletar exlui uma publicação do banco de dados
